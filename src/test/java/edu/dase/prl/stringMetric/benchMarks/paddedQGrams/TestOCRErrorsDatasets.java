...
public class TestOCRErrorsDatasets {
	...
	public static void testMain() throws Exception {
		...
		CSVFileReader dataset_1000_1_1_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_1000_1_1_org);
		CSVFileReader dataset_1000_1_1_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_1000_1_1_cor);
		CSVFileReader dataset_1000_2_2_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_1000_2_2_org);
		CSVFileReader dataset_1000_2_2_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_1000_2_2_cor);
		CSVFileReader dataset_500_1_1_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_500_1_1_org);
		CSVFileReader dataset_500_1_1_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_500_1_1_cor);
		CSVFileReader dataset_500_2_2_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_500_2_2_org);
		CSVFileReader dataset_500_2_2_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_500_2_2_cor);
		CSVFileReader dataset_200_1_1_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_200_1_1_org);
		CSVFileReader dataset_200_1_1_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_200_1_1_cor);
		CSVFileReader dataset_200_2_2_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_200_2_2_org);
		CSVFileReader dataset_200_2_2_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_OCR_ERR_EDITS_9999_200_2_2_cor);
