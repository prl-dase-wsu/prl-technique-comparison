...
public class TestCharacterEditsDatasets {
	...
	public static void testMain() throws Exception {
		...
		CSVFileReader dataset_1000_1_1_org_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_1000_1_1_org);
		CSVFileReader dataset_1000_1_1_cor_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_1000_1_1_cor);
		CSVFileReader dataset_1000_2_2_org_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_1000_2_2_org);
		CSVFileReader dataset_1000_2_2_cor_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_1000_2_2_cor);
		CSVFileReader dataset_500_1_1_org_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_500_1_1_org);
		CSVFileReader dataset_500_1_1_cor_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_500_1_1_cor);
		CSVFileReader dataset_500_2_2_org_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_500_2_2_org);
		CSVFileReader dataset_500_2_2_cor_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_500_2_2_cor);
		CSVFileReader dataset_200_1_1_org_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_200_1_1_org);
		CSVFileReader dataset_200_1_1_cor_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_200_1_1_cor);
		CSVFileReader dataset_200_2_2_org_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_200_2_2_org);
		CSVFileReader dataset_200_2_2_cor_reader = new CSVFileReader(null, DatasetListNonPaddedQGrams.SYNTH_CHAR_EDITS_9999_200_2_2_cor);
		...
		performLinkageBetweenDatasets(dataset_1000_1_1_org, "CharEdits-1000-1-1-org", dataset_1000_1_1_cor, "CharEdits-1000-1-1-cor", "CharEdits-1000-1-1");
		performLinkageBetweenDatasets(dataset_1000_2_2_org, "CharEdits-1000-2-2-org", dataset_1000_2_2_cor, "CharEdits-1000-2-2-cor", "CharEdits-1000-2-2");
		performLinkageBetweenDatasets(dataset_500_1_1_org, "CharEdits-500-1-1-org", dataset_500_1_1_cor, "CharEdits-500-1-1-cor", "CharEdits-500-1-1");
		performLinkageBetweenDatasets(dataset_500_2_2_org, "CharEdits-500-2-2-org", dataset_500_2_2_cor, "CharEdits-500-2-2-cor", "CharEdits-500-2-2");
		performLinkageBetweenDatasets(dataset_200_1_1_org, "CharEdits-200-1-1-org", dataset_200_1_1_cor, "CharEdits-200-1-1-cor", "CharEdits-200-1-1");
		performLinkageBetweenDatasets(dataset_200_2_2_org, "CharEdits-200-2-2-org", dataset_200_2_2_cor, "CharEdits-200-2-2-cor", "CharEdits-200-2-2");
	}
