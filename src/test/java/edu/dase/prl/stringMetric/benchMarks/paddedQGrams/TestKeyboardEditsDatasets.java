...
public class TestKeyboardEditsDatasets {
	...
	public static void testMain() throws Exception {
		...
		CSVFileReader dataset_1000_1_1_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_1000_1_1_org);
		CSVFileReader dataset_1000_1_1_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_1000_1_1_cor);
		CSVFileReader dataset_1000_2_2_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_1000_2_2_org);
		CSVFileReader dataset_1000_2_2_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_1000_2_2_cor);
		CSVFileReader dataset_500_1_1_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_500_1_1_org);
		CSVFileReader dataset_500_1_1_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_500_1_1_cor);
		CSVFileReader dataset_500_2_2_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_500_2_2_org);
		CSVFileReader dataset_500_2_2_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_500_2_2_cor);
		CSVFileReader dataset_200_1_1_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_200_1_1_org);
		CSVFileReader dataset_200_1_1_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_200_1_1_cor);
		CSVFileReader dataset_200_2_2_org_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_200_2_2_org);
		CSVFileReader dataset_200_2_2_cor_reader = new CSVFileReader(null, DatasetListPaddedQGrams.SYNTH_KEY_ERR_EDITS_9999_200_2_2_cor);
		...
		performLinkageBetweenDatasets(dataset_1000_1_1_org, "KeyboardEdits-1000-1-1-org", dataset_1000_1_1_cor, "KeyboardEdits-1000-1-1-cor", "KeyboardEdits-1000-1-1");
		performLinkageBetweenDatasets(dataset_1000_2_2_org, "KeyboardEdits-1000-2-2-org", dataset_1000_2_2_cor, "KeyboardEdits-1000-2-2-cor", "KeyboardEdits-1000-2-2");
		performLinkageBetweenDatasets(dataset_500_1_1_org, "KeyboardEdits-500-1-1-org", dataset_500_1_1_cor, "KeyboardEdits-500-1-1-cor", "KeyboardEdits-500-1-1");
		performLinkageBetweenDatasets(dataset_500_2_2_org, "KeyboardEdits-500-2-2-org", dataset_500_2_2_cor, "KeyboardEdits-500-2-2-cor", "KeyboardEdits-500-2-2");
		performLinkageBetweenDatasets(dataset_200_1_1_org, "KeyboardEdits-200-1-1-org", dataset_200_1_1_cor, "KeyboardEdits-200-1-1-cor", "KeyboardEdits-200-1-1");
		performLinkageBetweenDatasets(dataset_200_2_2_org, "KeyboardEdits-200-2-2-org", dataset_200_2_2_cor, "KeyboardEdits-200-2-2-cor", "KeyboardEdits-200-2-2");
	}
